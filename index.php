        ...
        <div class="row align-items-center" style="min-height:100vh; padding:130px 0 90px;">
            ...
            <div class="col-lg-6 col-xl-5">
                ...
                <p class="hero-desc reveal reveal-d2">
                    Intercity237 &mdash; plateforme centralisée de gestion
                    des réservation de tickets de bus interurbains.
                </p>
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6 reveal reveal-right">
                ...
                <p class="text-muted" style="font-size:1rem;line-height:1.8">
                    Intercity237 has been the backbone of Cameroon's
                ...
                <div class="mt-4">
                    ...
                    <div class="about-feat-item">
                        ...
                        <div>
                            ...
                            <div class="text-muted small mt-1">This Bus Booking centralises employee management, payroll records, and department reporting.</div>
                        </div>
                    </div>
                    <div class="about-feat-item">
        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-7 reveal">
                ...
                <p style="color:rgba(255,255,255,0.45);font-size:1rem;max-width:480px;margin:16px auto 0;line-height:1.8">
                    Request access to your department's Bus Booking. Manage records,
